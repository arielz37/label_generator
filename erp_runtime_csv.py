...
# BarTender may retain database bindings by column position. Keep all existing
# fields in place and append new fields only at the end of these lists.
RAW_RUNTIME_FIELDS = [
    "MO_NO",
    "SO_NO",
    "CUS_OS_NO",
...
def build_runtime_csv_row(
    ...
    return {
        ...
        "MFG_DATE_YYYY_MM_DD_SLASH": format_date_compact(mfg_date, "%Y/%m/%d"),
        "MFG_DATE_YY_MM_DD_SLASH": format_date_compact(mfg_date, "%y/%m/%d"),
        "MFG_DATE_YY": format_date_compact(mfg_date, "%y"),
        "MFG_DATE_YYYY": format_date_compact(mfg_date, "%Y"),
        "MFG_DATE_MM": format_date_compact(mfg_date, "%m"),
        "MFG_DATE_DD": format_date_compact(mfg_date, "%d"),
        "EXP_DATE": exp_date,
        ...
        "EXP_DATE_YYYY_MM_DD_SLASH": format_date_compact(exp_date, "%Y/%m/%d"),
        "EXP_DATE_YY_MM_DD_SLASH": format_date_compact(exp_date, "%y/%m/%d"),
        "EXP_DATE_YY": format_date_compact(exp_date, "%y"),
        "EXP_DATE_YYYY": format_date_compact(exp_date, "%Y"),
        "EXP_DATE_MM": format_date_compact(exp_date, "%m"),
        "EXP_DATE_DD": format_date_compact(exp_date, "%d"),
...
def build_label_csv_row(
    ...
    return {
        ...
        "MFG_DATE_YYYY_MM_DD_SLASH": runtime_row.get("MFG_DATE_YYYY_MM_DD_SLASH", ""),
        "MFG_DATE_YY_MM_DD_SLASH": runtime_row.get("MFG_DATE_YY_MM_DD_SLASH", ""),
        "MFG_DATE_YY": runtime_row.get("MFG_DATE_YY", ""),
        "MFG_DATE_YYYY": runtime_row.get("MFG_DATE_YYYY", ""),
        "MFG_DATE_MM": runtime_row.get("MFG_DATE_MM", ""),
        "MFG_DATE_DD": runtime_row.get("MFG_DATE_DD", ""),
        ...
        "EXP_DATE_YYYY_MM_DD_SLASH": runtime_row.get("EXP_DATE_YYYY_MM_DD_SLASH", ""),
        "EXP_DATE_YY_MM_DD_SLASH": runtime_row.get("EXP_DATE_YY_MM_DD_SLASH", ""),
        "EXP_DATE_YY": runtime_row.get("EXP_DATE_YY", ""),
        "EXP_DATE_YYYY": runtime_row.get("EXP_DATE_YYYY", ""),
        "EXP_DATE_MM": runtime_row.get("EXP_DATE_MM", ""),
        "EXP_DATE_DD": runtime_row.get("EXP_DATE_DD", ""),
